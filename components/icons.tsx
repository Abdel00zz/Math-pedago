...
export const EyeIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => <Icon iconName="visibility" {...props} />;
export const UndoIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => <Icon iconName="undo" {...props} />;
export const RedoIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => <Icon iconName="redo" {...props} />;
export const ChevronRightIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => <Icon iconName="chevron_right" {...props} />;
export const ChevronDownIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => <Icon iconName="expand_more" {...props} />;
export const GripVerticalIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => <Icon iconName="drag_indicator" {...props} />;
export const PlusIcon: React.FC<React.HTMLAttributes<HTMLSpanElement>> = (props) => <Icon iconName="add" {...props} />;