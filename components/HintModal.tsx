        ...
        >
            ...
            <ul className="space-y-3 max-h-[50vh] overflow-y-auto pr-2">
                {exercise.hint.map((hint, index) => (
                    <li key={index} className="flex items-start gap-3 p-4 bg-background rounded-lg border border-border serif-text text-text-secondary">
                        <span className="font-serif font-bold text-amber-500 text-base mt-1">❖</span>
