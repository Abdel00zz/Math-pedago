                    ...
                    {/* Message d'accueil avec présentation du professeur */}
                     <div className="text-center mb-6 md:mb-8">
                         ...
                         <div className="text-gray-700 text-base md:text-lg font-medium leading-relaxed" style={{ fontFamily: '"Fira Sans", sans-serif' }}>
                             Découvre une approche moderne et interactive pour maîtriser les mathématiques. Cette plateforme t'accompagne dans ton apprentissage avec des outils adaptés à ton rythme.
                         </div>
                     </div>
