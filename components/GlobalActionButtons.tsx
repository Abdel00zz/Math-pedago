...
const GlobalActionButtons: React.FC = () => {
    ...
    return (
        <>
            ...
            <div className="fixed top-4 right-16 z-40 hidden sm:flex items-center gap-3 p-1.5">
                ...
                <div className="group relative flex items-center">
                    ...
                    <span className="absolute left-1/2 -translate-x-1/2 top-full mt-3 w-max rounded-lg bg-surface/95 backdrop-blur-sm px-3 py-2 text-xs font-semibold text-text opacity-0 group-hover:opacity-100 transition-all duration-300 pointer-events-none shadow z-50">
                        Notifications
                    </span>
                </div>
