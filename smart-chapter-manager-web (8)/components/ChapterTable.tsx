...
interface ChapterTableProps {
    ...
    onUpdateActive: (chapterId: string, isActive: boolean) => void;
}
                                ...
                                <td className="px-6 py-4 whitespace-nowrap">
                                    <label className="flex items-center cursor-pointer">
                                        <div className="relative">
                                            <input type="checkbox" className="sr-only" checked={chapter.is_active} onChange={(e) => onUpdateActive(chapter.id, e.target.checked)} />
